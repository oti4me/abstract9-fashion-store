...
@push('styles')
    ...
    <link href="{{ asset('/js/fashion/jquery.scrollUp.min.js') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('/js/fashion/price-range.js') }}" rel="stylesheet" type="text/css">
